<%@ Control Language="C#" CodeFile="Green_Admin_Banche.ascx.cs" Inherits="Green.Apple.Management.Green_Admin_Banche " %>
                    ...
                    <td colspan="2" valign="top">
                        <asp:DataGrid ID="gridData" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn><HeaderStyle Width="400px" /></asp:BoundColumn>
                                <asp:BoundColumn></asp:BoundColumn> 
                                <asp:BoundColumn></asp:BoundColumn> 
            ...
            <table id="TBLModifica" runat="server" cellpadding="0" cellspacing="0" width="100%" border="0" style="border: 1px solid #999999;">
                ...
                <tr>
                    ...
                    <td class="form_textarea" width="80%">
                        <asp:TextBox ID="txtElemento" runat="server" MaxLength="200" Width="98%"></asp:TextBox><asp:RequiredFieldValidator ID="reqElemento" runat="server" ControlToValidate="txtElemento" ErrorMessage="*" Font-Bold="True">*</asp:RequiredFieldValidator>
                    </td>
                ...
                <tr>
                    ...
                    <td class="form_textarea" width="80%">
                        <asp:TextBox ID="txtIban" runat="server" MaxLength="50" Width="98%"></asp:TextBox><asp:RequiredFieldValidator ID="reqCodice" runat="server" ControlToValidate="txtIban" ErrorMessage="*" Font-Bold="True">*</asp:RequiredFieldValidator>
                    </td>
                ...
                <tr>
                    ...
                    <td class="form_textarea" width="80%">
                        <asp:TextBox ID="txtSwift" runat="server" MaxLength="50" Width="98%"></asp:TextBox><asp:RequiredFieldValidator ID="reqCodice2" runat="server" ControlToValidate="txtSwift" ErrorMessage="*" Font-Bold="True">*</asp:RequiredFieldValidator>
                    </td>
