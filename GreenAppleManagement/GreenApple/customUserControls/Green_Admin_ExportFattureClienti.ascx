<%@ Control Language="C#" CodeFile="Green_Admin_ExportFattureClienti.ascx.cs" Inherits="Green.Apple.Management.Green_Admin_ExportFattureClienti" %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                <tr>
                    <td class="box_Menu_Item">
                        <asp:LinkButton ID="lnkEsporta" Font-Bold="true" runat="server" OnClick="lnkEsporta_Click"><img src='../customLayout/images/icoNew.gif' border='0'>&nbsp;ESPORTA TUTTE LE FATTURE</asp:LinkButton>
                    </td>
                </tr>
                <tr>
                    <td class="box_Menu_Item">
