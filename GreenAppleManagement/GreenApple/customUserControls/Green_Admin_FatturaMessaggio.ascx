<%@ Control Language="C#" CodeFile="Green_Admin_FatturaMessaggio.ascx.cs" Inherits="Green.Apple.Management.Green_Admin_FatturaMessaggio " %>
                    ...
                    <td colspan="2" valign="top">
                        <asp:DataGrid ID="gridData" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn><HeaderStyle Width="50px" /></asp:BoundColumn> 
                                <asp:BoundColumn><HeaderStyle Width="350px" /></asp:BoundColumn>
