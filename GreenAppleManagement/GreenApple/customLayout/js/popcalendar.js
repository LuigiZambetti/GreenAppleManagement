...
// TabSize: 4
//
// modified by Bard A.Evjen (bardevjen@operamail.com) 14 August 2003
//      - norwegian language included.
// - new enableFuture function
//     
// modified by skriptor 1 August 2003
//  content of pulldown menus are refreshed after changing the month
//  tooltip for CloseButton (to do: check spanish text)
//  new parameters for showWeekNumber and startAt in showCalendar()
//  now we are really multilingual
//
...
var imgDir = '../customLayout/images/calendar/';  // directory for images ... e.g. var imgDir="/img/"
var dayName = '';
...
var monthName2 = {
    it: new Array('JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC'),
...
function hideCalendar() {
    ...
    if (typeof document.body.style.maxHeight != "undefined") {
        ...
        for (var i = 0; i < elementsSELECT.length; i++) {
            elementsSELECT[i].style.visibility = ''
        }
    }
...
function constructMonth() {
    ...
    if (!monthConstructed) {
        ...
        for (i = 0; i < 12; i++) {
            ...
            sHTML += '<tr><td id="m' + i + '" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" style="cursor:pointer" onclick="monthConstructed=false;monthSelected=' + i + ';constructCalendar();popDownMonth();event.cancelBubble=true"><font color="#164781">&nbsp;' + sName + '&nbsp;</font></td></tr>';
        }
...
function constructYear() {
    ...
    sHTML = '';
    if (!yearConstructed) {
        sHTML = '<tr><td align="center" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="clearInterval(intervalID1);this.style.backgroundColor=\'\'" style="cursor:pointer" onmousedown="clearInterval(intervalID1);intervalID1=setInterval(\'decYear()\',30)" onmouseup="clearInterval(intervalID1)"><font color="#164781">-</font></td></tr>';
        ...
        for (i = (yearSelected - 3) ; i <= (yearSelected + 3) ; i++) {
            ...
            sHTML += '<tr><td id="y' + j + '" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="this.style.backgroundColor=\'\'" style="cursor:pointer" onclick="selectYear(' + j + ');event.cancelBubble=true"><font color="#164781">&nbsp;' + sName + '&nbsp;</font></td></tr>';
            j++;
        }

        sHTML += '<tr><td align="center" onmouseover="this.style.backgroundColor=\'#909090\'" onmouseout="clearInterval(intervalID2);this.style.backgroundColor=\'\'" style="cursor:pointer" onmousedown="clearInterval(intervalID2);intervalID2=setInterval(\'incYear()\',30)" onmouseup="clearInterval(intervalID2)"><font color="#164781">+</font></td></tr>';
...
function constructCalendar() {
    ...
    sHTML1 = "<a href='javascript:hideCalendar()' onmouseover='window.status=\"" + selectCloseMessage[language] + "\";return true' onmouseout='window.status=\"\"'><IMG SRC='" + imgDir + "close.gif' WIDTH='15' HEIGHT='13' BORDER='0' ALT='" + selectCloseMessage[language] + "'></a>";
    document.getElementById("lblClose").innerHTML = sHTML1
    ...
    for (i = 0; i < 7; i++) {
        sHTML += '<td width="27" align="right"><b><font color="#164781">' + dayName[language][i] + '</font></b></td>';
    }
...
function showCalendar(ctl, ctl2, format, lang, past, future, fx, fy, week, start) {
    ...
    if (week != null) showWeekNumber = week;
    else showWeekNumber = 0;
    if (start != null) startAt = start;
    else startAt = 1;
    ...
    if (typeof document.body.style.maxHeight != "undefined") {
        ...
        var elementsSELECT = document.getElementsByTagName('SELECT');
        for (var i = 0; i < elementsSELECT.length; i++) {
            elementsSELECT[i].style.visibility = 'hidden';
        }
    }
