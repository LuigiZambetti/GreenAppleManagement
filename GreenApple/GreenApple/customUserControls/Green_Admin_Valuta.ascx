<%@ Control Language="C#" CodeFile="Green_Admin_Valuta.ascx.cs" Inherits="Green.Apple.Management.Green_Admin_Valuta " %>
                    ...
                    <td colspan="2" valign="top">
                        <asp:DataGrid ID="gridData" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn></asp:BoundColumn>
                                <asp:BoundColumn><HeaderStyle Width="650px" /></asp:BoundColumn>
                                <asp:BoundColumn></asp:BoundColumn>
            ...
            <table id="TBLModifica" runat="server" cellpadding="0" cellspacing="0" width="100%" border="0" style="border: 1px solid #999999;">
                ...
                <tr>
                    ...
                    <td class="form_textarea" width="80%">
                        <asp:TextBox ID="txtCodice" runat="server" MaxLength="5" Width="10%"></asp:TextBox><asp:RequiredFieldValidator ID="reqCodice" runat="server" ControlToValidate="txtCodice" ErrorMessage="*" Font-Bold="True">*</asp:RequiredFieldValidator>
                    </td>
