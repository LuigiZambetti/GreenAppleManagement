<%@ Control Language="C#" CodeFile="Green_Admin_News.ascx.cs" Inherits="Green.Apple.Management.Green_Admin_News" %>
                ...
                <tr>
                    <td colspan="2" valign="top">
                        <asp:DataGrid ID="gridData" runat="server" 
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="IdNews" HeaderText="ID" Visible="false"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="Titolo" HeaderText="Nome" ></asp:BoundColumn>
            ...
            <table id="TBLModifica" runat="server" cellpadding="0" cellspacing="0" width="100%" border="0" style="border: 1px solid #999999;">
                <tr>
                    <td colspan="2" class="form_AnagraficaInsert">
                        <a name="SectionEdit"></a>Inserimento/Modifica News
                        :
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="form_textarea">
                        <asp:CheckBox ID="chkChiusa" runat="server" Text="La News risulta chiusa"/>
                    </td>
                </tr>
