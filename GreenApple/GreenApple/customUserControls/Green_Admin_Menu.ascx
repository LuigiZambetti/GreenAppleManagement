<%@ Control Language="C#" CodeFile="Green_Admin_Menu.ascx.cs" Inherits="Green.Apple.Management.Green_Admin_Menu" %>
<table cellpadding="0" cellspacing="0" width="100%" height="100%">
    <tr>
        <td class="form_Title" colspan="3">
            &nbsp;&nbsp;Amministrazione - Menu Applicazione
        </td>
    </tr>
    <tr height="5">
        <td colspan="3">
                ...
                <tr>
                    <td colspan="2" valign="top">
                        <asp:DataGrid ID="gridData" runat="server" 
                            ...
                            GridLines="Horizontal" OnItemCommand="gridData_ItemCommand" PageSize="100">
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="IdMenu" HeaderText="ID" Visible="false"></asp:BoundColumn>
                                ...
                                <asp:BoundColumn DataField="SimpleList" HeaderText="Is Simple" ></asp:BoundColumn>
                                <asp:BoundColumn DataField="Tabella" HeaderText="Tabella" ></asp:BoundColumn>
                                <asp:BoundColumn DataField="Pagina" HeaderText="Pagina" ></asp:BoundColumn>
            ...
            <table id="TBLModifica" runat="server" cellpadding="0" cellspacing="0" width="100%" border="0" style="border: 1px solid #999999;">
                ...
                <tr>
                    ...
                    <td class="form_textarea" width="80%">
                        <asp:TextBox ID="txtVoce" runat="server" MaxLength="255" Width="98%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reqElemento" runat="server" ControlToValidate="txtVoce" ErrorMessage="*" Font-Bold="True">*</asp:RequiredFieldValidator>
                    </td>
                ...
                <tr>
                    ...
                    <td class="form_textarea">
                        <asp:TextBox ID="txtGruppo" runat="server" MaxLength="80" Width="98%"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtGruppo" ErrorMessage="*" Font-Bold="True">*</asp:RequiredFieldValidator>
                    </td>
                ...
                <tr>
                    ...
                    <td class="form_textarea">
                        <asp:CheckBox ID="txtSimpleList" runat="server"  Text="Is simple list?"/>
                    </td>
                </tr>
                <tr>
                    <td class="form_text">
                    ...
                    <td class="form_textarea">
                        <asp:TextBox ID="txtTabella" runat="server" MaxLength="80" Width="98%"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="form_textarea">
                        <asp:TextBox ID="txtPagina" runat="server" MaxLength="80" Width="98%"></asp:TextBox>
                    </td>
